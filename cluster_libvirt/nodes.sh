...
#NODES="$NODES ose3-node4.test.example.com"
#NODES="$NODES ose3-node5.test.example.com"
#NODES="$NODES ose3-node6.test.example.com"
#NODES="$NODES ose3-node7.test.example.com"
